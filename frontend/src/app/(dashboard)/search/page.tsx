  ...
  return (
    <AppShell>
      <div className="p-4 md:p-6">
        <h1 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">询问和搜索</h1>
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'ask' | 'search')} className="w-full space-y-6">
          <div className="space-y-2">
            ...
            <TabsList aria-label="询问或搜索您的知识库" className="w-full max-w-xl">
          ...
          <TabsContent value="ask" className="mt-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">询问您的知识库 (beta)</CardTitle>
                <p className="text-sm text-muted-foreground">
                  LLM 将根据您知识库中的文档回答您的查询。
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                {!hasEmbeddingModel ? (
                  <div className="flex items-center gap-2 p-3 text-sm text-amber-600 dark:text-amber-500 bg-amber-50 dark:bg-amber-950/20 rounded-md">
                    ...
                    <span>您无法使用此功能，因为您没有选择嵌入模型。请在模型页面中设置一个。</span>
                  </div>
                ) : (
                  <>
                    <div className="space-y-2">
                ...
                {searchMutation.data && (
                  <div className="mt-6 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline">{searchMutation.data.search_type} 搜索</Badge>
                    </div>
