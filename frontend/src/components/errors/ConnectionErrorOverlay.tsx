        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {isApiError
                ? '无法连接到 Open Notebook API 服务器'
                : 'API 服务器正在运行，但数据库无法访问'}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4 border-l-4 border-primary pl-4">
          ...
          {isApiError ? (
            <div className="space-y-2 text-sm bg-muted p-4 rounded">
              <p className="font-medium">设置 API_URL 环境变量：</p>
            ...
            <div className="space-y-2 text-sm bg-muted p-4 rounded">
              <p className="font-medium">检查 SurrealDB 是否正在运行：</p>
              <code className="block bg-background p-2 rounded text-xs">
                # For Docker:
                <br />
            ...
            <CollapsibleContent className="pt-4">
              <div className="space-y-2 text-sm bg-muted p-4 rounded font-mono">
                {error.details.attemptedUrl && (
                  <div>
                    <strong>尝试访问的 URL：</strong> {error.details.attemptedUrl}
                  </div>
                )}
