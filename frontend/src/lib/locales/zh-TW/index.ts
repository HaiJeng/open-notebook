export const zhTW = {
  ...
  notebooks: {
    ...
    addDescription: "新增描述...",
    personaLabel: "筆記本人格",
    personaPlaceholder: "描述此筆記本的人格提示詞,例如角色、語氣、行為準則等(支持 Markdown)...",
    personaNotSet: "未設定(使用默認提示詞)",
    editPersona: "編輯人格提示詞",
    editPersonaTitle: "編輯筆記本對話人格",
    editPersonaDesc: "定義當前筆記本的對話人格、語氣和行為準則。此內容會覆蓋默認的系統提示詞(支持 Markdown)。",
    noNotesYet: "暫無筆記",
    deleteNote: "刪除筆記",
