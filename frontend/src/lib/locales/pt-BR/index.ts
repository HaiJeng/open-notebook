export const ptBR = {
  ...
  notebooks: {
    ...
    personaLabel: "Persona do Caderno",
    personaPlaceholder: "Descreva a persona deste caderno, como papel, tom, diretrizes de comportamento, etc. (suporta Markdown)...",
    personaNotSet: "Não definido (usando prompt padrão)",
    editPersona: "Editar Prompt de Persona",
    editPersonaTitle: "Editar Persona do Caderno",
    editPersonaDesc: "Defina a persona de conversação, tom e diretrizes de comportamento para este caderno. Este conteúdo substituirá o prompt padrão do sistema (suporta Markdown).",
