export const enUS = {
  ...
  notebooks: {
    ...
    personaLabel: "Notebook Persona",
    personaPlaceholder: "Describe this notebook's persona, such as role, tone, behavior guidelines, etc. (supports Markdown)...",
    personaNotSet: "Not set (using default prompt)",
    editPersona: "Edit Persona Prompt",
    editPersonaTitle: "Edit Notebook Persona",
    editPersonaDesc: "Define the conversation persona, tone, and behavior guidelines for this notebook. This content will override the default system prompt (supports Markdown).",
