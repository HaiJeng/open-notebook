export const zhCN = {
  ...
  notebooks: {
    ...
    personaLabel: "笔记本人格",
    personaPlaceholder: "描述此笔记本的人格提示词,例如角色、语气、行为准则等(支持 Markdown)...",
    personaNotSet: "未设置(使用默认提示词)",
    editPersona: "编辑人格提示词",
    editPersonaTitle: "编辑笔记本对话人格",
    editPersonaDesc: "定义当前笔记本的对话人格、语气和行为准则。此内容会覆盖默认的系统提示词(支持 Markdown)。",
